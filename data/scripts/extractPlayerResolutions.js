...
async function extract() {
	...
	var existingPath = __dirname + '/player-resolutions.json';
	try {
		existingResolutions = require('./player-resolutions.json');
	...
	console.log('\nWrote', Object.keys(sortedResolutions).length, 'resolutions to data/scripts/player-resolutions.json');
